...
public void settings() {
 ...
 for(int i=0; i<rowOneDeskNumbers; i++){
    buttonsOne[i] = new RowOneButton("t",115,25+i*105,85,104,colors[1],colors[0]);
  }
  ...
  for(int i=0; i<rowTwoDeskNumbers; i++){
    buttonsTwo[i] = new RowTwoButton("t",203,25+i*105,85,104,colors[1],colors[0]);
  }
  ...
  for(int i=0; i<rowThreeDeskNumbers; i++){
    buttonsThree[i] = new RowThreeButton("t",496,25+i*105,85,104,colors[1],colors[0]);
  }
  ...
  for(int i=0; i<rowFourDeskNumbers; i++){
    buttonsFour[i] = new RowFourButton("t",584,25+i*105,85,104,colors[1],colors[0]);
  }
